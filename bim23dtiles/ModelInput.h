...
namespace XBSJ {
	...
	// this is a key class responsible for reading ifc files and hold the 
	// data and reader, which aslo include user's param about how this software
	// works.  the reader generated by plugins(eg: pluginIfcpplast)
	class ModelInput
	{
	public:
